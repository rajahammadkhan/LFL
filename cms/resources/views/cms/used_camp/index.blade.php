        ...
        <div class="row mt-0">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Approved Ticket List</h4>

                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Approved Ticket List</li>
                        </ol>
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="
                            ...
                            <thead class="datatable">
                                <tr>
                                    ...
                                    <th class="no-sort text-center">Address</th>
                                    <th class="no-sort text-center">Ticket Name</th>
                                    <th class="no-sort text-center" width="7%">Qty</th>
...
@include('cms.used_camp.includes.used_camp-js')
@endsection