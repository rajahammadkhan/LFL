<script type="text/javascript">
    ...
    "targets": 2,
    "render": function(data, type, row, meta) {
        // Assuming 'data' contains the image URL for the current row
        return `<p>http://localhost/RPM%20Project/CmsRpm/public/uploads/${data}</p>`;
    },
},
            {
                "targets": 3,
                "render": function(data, type, row, meta) {
                    ...
                    var edit = "{{ route('campimg.edit', [':id']) }}";
