            ...
            <div class="row layout-top-spacing" id="cancel-row">
                <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Camp Image</li>
                    </ol>
                    <div class="widget-content widget-content-area br-6">
                        <div style="background: rgba(0, 0, 0, 0.8);">
                            <div class="row">
                                <div class="col-md-6 mt15 pl30">
                                    <h5 class="text-white">Camp Image</h5>
                                </div>
                                    <div class="col-md-6 text-right">
                                        <a href="{{ route('campimg.create') }}" class="btn btn-danger mb-2 mr-4 ml-3 mt-2">Add</a>
                                    </div>
                            </div>
                        </div>
                        <br>
...
@include('cms.camp_img.includes.camp_img-js')
@endsection
